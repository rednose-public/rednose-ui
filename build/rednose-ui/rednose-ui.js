/*!
 * RedNoseUI v1.6.0-dev (http://www.rednose.nl)
        ...
        **/
        ...
        if (!Env) {
            Y.Env = {
                ...
                // .js               and ending in ".js"
                _BASE_RE: /(?:\?(?:[^&]*&)*([^&]*))?\b(rednose-ui(?:-\w+)?)\/\2(?:-(min|debug))?\.js/,
...
YUI.add('rednose-base', function (Y, NAME) {

/* This file is auto-generated by (yogi loader --json false --tests false -js js/rednose-loader.js --yes --mix --start ../) */
