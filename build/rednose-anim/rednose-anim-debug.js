...
Anim.slideOutY = function (node) {
    // Make sure the childElement is not hidden, otherwise height cannot be
    // calculated.
...
Anim.fadeOut = function (node) {
    var clone = node.cloneNode(true).set('id', null).setStyle('position', 'absolute'),
        anim;
...
/**
 * Vortex effect, animate to a given location while reducing dimensions and opacity.
 *
 * @method vortex
 * @param {Node} node A node
