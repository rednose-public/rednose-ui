...
contextMenu.get('boundingBox').setStyle('top', e.pageY);
        ...
        _yuitest_coverline("build/libbit-contextmenu/libbit-contextmenu.js", 83);
...
contextMenu.show();
    ...
    _bindContextMenu: function () {
        _yuitest_coverfunc("build/libbit-contextmenu/libbit-contextmenu.js", "_bindContextMenu", 89);
...
contextMenu.get('boundingBox').all('a').on(['click', 'contextmenu'], function (e) {
            _yuitest_coverfunc("build/libbit-contextmenu/libbit-contextmenu.js", "(anonymous 3)", 95);
...
contextMenu.get('boundingBox').all('li').on('mouseenter', function (e) {
            _yuitest_coverfunc("build/libbit-contextmenu/libbit-contextmenu.js", "(anonymous 4)", 105);
...
contextMenu.get('boundingBox').all('li').on('mouseleave', function (e) {
            _yuitest_coverfunc("build/libbit-contextmenu/libbit-contextmenu.js", "(anonymous 5)", 113);
...
contextMenu.get('boundingBox').on('clickoutside', function (e) {
            ...
            _yuitest_coverfunc("build/libbit-contextmenu/libbit-contextmenu.js", "(anonymous 6)", 121);
_yuitest_coverline("build/libbit-contextmenu/libbit-contextmenu.js", 125);
if (e.button !== 3) {
