...
this.rendered && this.render();
    ...
    _handleToggle: function (e) {
        _yuitest_coverfunc("build/libbit-treeview/libbit-treeview.js", "_handleToggle", 268);
...
htmlNode.one('.libbit-treeview-icon').set('className', this.icon(node));
    ...
    _handleExpand: function (e) {
         _yuitest_coverfunc("build/libbit-treeview/libbit-treeview.js", "_handleExpand", 275);
...
this._stateMap.push(id);
    ...
    _handleCollapse: function (e) {
        _yuitest_coverfunc("build/libbit-treeview/libbit-treeview.js", "_handleCollapse", 284);
...
this._stateMap.splice(index, 1);
    ...
    _destroyContainer: function () {
        _yuitest_coverfunc("build/libbit-treeview/libbit-treeview.js", "_destroyContainer", 299);
