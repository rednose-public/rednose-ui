...
this.rendered && this.render();
    ...
    _handleToggle: function (e) {
        _yuitest_coverfunc("build/libbit-treeview/libbit-treeview.js", "_handleToggle", 267);
...
htmlNode.one('.libbit-treeview-icon').set('className', this.icon(node));
    ...
    _handleExpand: function (e) {
         _yuitest_coverfunc("build/libbit-treeview/libbit-treeview.js", "_handleExpand", 274);
...
this._stateMap.push(id);
    ...
    _handleCollapse: function (e) {
        _yuitest_coverfunc("build/libbit-treeview/libbit-treeview.js", "_handleCollapse", 283);
...
this._stateMap.splice(index, 1);
    ...
    _destroyContainer: function () {
        _yuitest_coverfunc("build/libbit-treeview/libbit-treeview.js", "_destroyContainer", 298);
_yuitest_coverline("build/libbit-treeview/libbit-treeview.js", 299);
var container = this.get('container');
