...
self._setExpandedIcon(expandedNode);
     ...
     */
     _restoreState: function () {
        _yuitest_coverfunc("build/libbit-treeview/libbit-treeview.js", "_restoreState", 226);
...
nodes = tree.getNodesBy(function (node) {
                _yuitest_coverfunc("build/libbit-treeview/libbit-treeview.js", "(anonymous 14)", 232);
...
Y.Array.each(nodes, function (node) {
                _yuitest_coverfunc("build/libbit-treeview/libbit-treeview.js", "(anonymous 15)", 236);
...
this._stateMap = [];
    ...
    _getModelFromLabelNode: function (node) {
        _yuitest_coverfunc("build/libbit-treeview/libbit-treeview.js", "_getModelFromLabelNode", 247);
...
return node.ancestor('table').getData().model;
    ...
    _getTableElement: function (node) {
        _yuitest_coverfunc("build/libbit-treeview/libbit-treeview.js", "_getTableElement", 254);
...
return boundingBox.one('#' + id).ancestor('table');
    ...
    _setCollapsedIcon: function (el) {
        _yuitest_coverfunc("build/libbit-treeview/libbit-treeview.js", "_setCollapsedIcon", 264);
...
a.setContent(Y.Node.create('<i class="icon-toggle icon-chevron-right"></i>'));
    ...
    _setExpandedIcon: function (el) {
        _yuitest_coverfunc("build/libbit-treeview/libbit-treeview.js", "_setExpandedIcon", 278);
