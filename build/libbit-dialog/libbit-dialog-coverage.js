...
_yuitest_coverline("build/libbit-dialog/libbit-dialog.js", 335);
Dialog.error = function (title, message) {
    _yuitest_coverfunc("build/libbit-dialog/libbit-dialog.js", "error", 335);
_yuitest_coverline("build/libbit-dialog/libbit-dialog.js", 336);
var node,
        panel;

    _yuitest_coverline("build/libbit-dialog/libbit-dialog.js", 339);
node = Y.Node.create(
        '<div class="icon dialog_error_icon"></div>' +
        '<div><p class="text-error">' + message + '</p></div>'
    );

    _yuitest_coverline("build/libbit-dialog/libbit-dialog.js", 344);
panel = new Y.Panel({
        bodyContent: node,
        headerContent: title,
        zIndex: Y.all('*').size(),
        ...
        buttons: [
             {
                ...
                isDefault: true,
                action : function () {
                    _yuitest_coverfunc("build/libbit-dialog/libbit-dialog.js", "action", 358);
_yuitest_coverline("build/libbit-dialog/libbit-dialog.js", 359);
panel.destroy();
                }
             }
        ]
    ...
    _yuitest_coverline("build/libbit-dialog/libbit-dialog.js", 365);
panel.get('boundingBox').addClass('libbit-dialog');
};

// -- Namespace ----------------------------------------------------------------
_yuitest_coverline("build/libbit-dialog/libbit-dialog.js", 369);
